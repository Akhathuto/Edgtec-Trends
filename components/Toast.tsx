...
const Toast: React.FC<ToastProps> = ({ message, onClose, duration = 3000 }) => {
  ...
  return (
    <div className="fixed bottom-16 sm:bottom-4 right-4 z-50 bg-green-500/20 text-white p-4 rounded-lg shadow-2xl flex items-center gap-3 animate-slide-in-up backdrop-blur-md border border-green-500/50">
