                ...
                <div className="flex flex-col items-center sm:flex-row sm:items-start text-center sm:text-left">
                    ...
                    <div>
                        ...
                        <div className="mt-2 flex items-center gap-2 justify-center sm:justify-start">
                            <span className={`inline-block font-bold text-sm px-3 py-1 rounded-full ${user.plan === 'pro'
                             ...
                             {user.role === 'admin' && (
                                <span className="inline-flex items-center gap-1.5 font-bold text-sm px-3 py-1 rounded-full bg-blue-500/20 text-blue-300">
