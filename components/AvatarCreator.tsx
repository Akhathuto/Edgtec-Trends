            ...
            {phase === 'design' && (
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    <div className="lg:col-span-3 bg-brand-glass border border-slate-700/50 rounded-2xl p-6 space-y-5">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-2"><button onClick={handleSurpriseMe} disabled={isSurprising || loading} className="button-secondary w-full"><Wand className="w-5 h-5 mr-2"/> Surprise Me!</button><button onClick={handleGenerate} disabled={loading || isSurprising} className="button-primary w-full !py-3 !text-base"><UserIcon className="w-5 h-5 mr-2"/> Generate Avatar</button></div>
                    </div>
