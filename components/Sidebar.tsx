    ...
    <aside className="w-80 flex-shrink-0 bg-brand-glass border-r border-slate-700/50 p-3 h-[calc(100vh-65px)] sticky top-[65px] overflow-y-auto">
      ...
      <nav className="flex flex-col space-y-1">
        ...
        <div>
            ...
            <div className={`transition-[max-height] duration-300 ease-in-out overflow-hidden ${collapsedSections.create ? 'max-h-0' : 'max-h-screen'}`}>
        ...
        <div>
            ...
            <div className={`transition-[max-height] duration-300 ease-in-out overflow-hidden ${collapsedSections.strategy ? 'max-h-0' : 'max-h-screen'}`}>
                <div className="space-y-1 pt-1">
