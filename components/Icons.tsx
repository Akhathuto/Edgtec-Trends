...
export const Youtube: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M2.5 17a24.12 24.12 0 0 1 0-10C2.5 4.24 4.24 2.5 7 2.5h10c2.76 0 4.5 1.74 4.5 4.5a24.12 24.12 0 0 1 0 10c0 2.76-1.74 4.5-4.5 4.5H7c-2.76 0-4.5-1.74-4.5-4.5Z" />
...
export const TikTok: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.43.03-4.83-.95-6.43-2.88-1.59-1.92-2.31-4.58-1.9-7.08.3-2.15 1.33-4.14 2.89-5.57.91-.84 2.01-1.46 3.23-1.78.04-1.5.02-3.01.01-4.52.21-.13.4-.26.6-.39.61-.39 1.25-.74 1.91-1.02 1.06-.45 2.19-.78 3.39-.95z" />
    </svg>
);

export const YoutubeShorts: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <rect x="6" y="2" width="12" height="20" rx="2" ry="2" />
      <path d="m11 9 5 3-5 3V9z" />
    </svg>
);

export const Film: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M14.5 5.5 22 9.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h10.5Z" />
    <path d="m8 8 3 3-3 3" />
  </svg>
);
...
export const Whatsapp: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M16.6 14.2c-.2-.1-1.5-.7-1.7-.8-.2-.1-.4-.1-.6.1-.2.2-.6.7-.8.9-.1.1-.3.2-.5.1-.2-.1-.9-.3-1.8-1.1-.7-.6-1.1-1.3-1.3-1.6-.1-.2 0-.4.1-.5.1-.1.2-.2.4-.4.1-.1.2-.2.2-.3.1-.1.1-.3 0-.4-.1-.1-.6-1.5-.8-2-.2-.5-.4-.4-.5-.4h-.5c-.2 0-.4.1-.6.3-.2.2-.8.8-.8 1.9 0 1.1.8 2.2 1 2.4.1.1 1.5 2.3 3.6 3.2.5.2 1 .4 1.3.5.5.1 1 .1 1.3.1.4-.1.6-.2.8-.4.2-.2.2-.4.1-.5zM12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18.2c-4.5 0-8.2-3.7-8.2-8.2S7.5 3.8 12 3.8s8.2 3.7 8.2 8.2-3.7 8.2-8.2 8.2z" />
    </svg>
);
...
// FIX: Added missing Volume2 icon.
...
// FIX: Added missing VolumeX icon.
...
export const Rocket: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.11.64-1.51 1.83-2.73 3.05-4.04.33-.36.72-.69 1.12-1.01.08-.06.16-.12.24-.18a2.5 2.5 0 0 1 3.54 0l1.51 1.51a2.5 2.5 0 0 1 0 3.54l-1.01 1.01" /><path d="m21.5 21.5-3.04-3.04" />
    </svg>
);
...
export const PayPal: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M8.32 21.18c.24.16.5.28.77.34.06 0 .1.01.16.02h.15c.12 0 .24-.02.35-.05.18-.05.35-.13.5-.24.22-.16.4-.37.53-.62.1-.21.15-.43.15-.66 0-.4-.13-.76-.38-1.06-.26-.3-.63-.49-1.1-.55-.42-.05-.85-.02-1.28.06-1.12.23-2.24.4-3.36.56-1.04.15-2.08.26-3.12.33-.29.02-.45-.03-.51-.12-.06-.1-.02-.27.08-.5.22-.48.45-.96.67-1.44.11-.23.23-.47.34-.7.08-.16.09-.3.02-.41-.07-.11-.25-.13-.48-.13h-1.1c-.55 0-.96.06-1.22.18-.3.14-.54.34-.7.6-.17.26-.25.56-.25.9s.08.67.24.96c.16.29.38.52.65.69.27.17.58.28.92.33.56.09 1.12.14 1.68.16 1.25.04 2.5-.01 3.75-.12 1.4-.12 2.8-.3 4.2-.53h.01z"/>
    <path d="M21.18 9.38c-.36-2.07-2.2-3.6-4.32-3.6h-5.46c-1.37 0-2.68.6-3.56 1.7-1.12 1.4-1.5 3.3-1.04 5.1.37 1.48 1.42 2.7 2.8 3.38.56.28 1.16.46 1.78.55l.02.01c.22.03.44.06.66.08.19.02.38.03.57.03.52 0 1.02-.08 1.5-.23.82-.26 1.53-.8 1.95-1.55.33-.59.43-1.29.28-1.98-.11-.53-.42-.98-.88-1.3s-1.03-.5-1.7-.55c-.56-.05-1.13-.02-1.69.06-.38.06-.75.13-1.12.21l.06.33c.48-1.07 1.53-1.8 2.73-1.96.38-.05.77-.08 1.15-.08.9 0 1.75.25 2.45.74.7.48 1.13 1.24 1.18 2.1.05.86-.3 1.68-1.02 2.22-.72.54-1.66.75-2.6.58-.29-.05-.57-.13-.85-.23-.62-.21-1.22-.5-1.78-.86-.4-.26-.76-.56-1.08-.89-.28-.3-.52-.61-.7-.94-.05-.08-.09-.17-.13-.25l1.19-5.18c.12-.53.53-.94 1.04-1.04h3.4c1.1 0 2.05.73 2.27 1.8.04.18.06.36.07.54z"/>
  </svg>
);
...
export const Gif: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <rect x="2" y="6" width="20" height="12" rx="2" />
    <path d="M7.5 15h2" />
    <path d="M16.5 9h-3v6h3" />
    <path d="M11 9v6" />
  </svg>
);

export const Clapperboard: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const PenTool: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="m18 13-1.5-7.5-7.5-1.5 7.5 7.5z" />
