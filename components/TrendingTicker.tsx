...
const TrendingTicker: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-dark-card/80 backdrop-blur-md border-t border-gray-700 overflow-hidden group animate-fade-in">
            <div className="flex items-center h-12">
                <div className="flex-shrink-0 bg-brand-purple h-full flex items-center px-4">
                ...
                <button 
                    ...
                    className="flex-shrink-0 h-full flex items-center px-4 text-gray-400 hover:text-white hover:bg-gray-700/50 transition-colors"
