...
import { History as HistoryIcon, FileText, Copy, Download } from '../components/Icons';
import { ToolId, HistoryItem, HistoryContentType } from '../types';
        ...
        <div className="animate-slide-in-up space-y-8">
            <div className="bg-brand-glass border border-slate-700/50 rounded-xl p-6 shadow-xl backdrop-blur-xl">
                <h2 className="text-2xl font-bold text-center mb-1 text-slate-100 flex items-center justify-center gap-2">
                    <HistoryIcon className="w-6 h-6 text-violet-400" /> My Content
                </h2>
