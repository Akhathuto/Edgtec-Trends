...
import { User, ActivityLog, ToolId } from '../types';
import { Sliders, User as UserIcon, Activity, Lightbulb, Star, Video, Search, MessageSquare, Trash2, Edit } from '../components/Icons';
                                        ...
                                        <tr key={managedUser.id} className="hover:bg-slate-800/40 transition-colors">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <select
                                                    ...
                                                    className="w-full bg-slate-700/50 border border-slate-600 rounded-lg py-1.5 px-3 text-sm text-slate-100 focus:outline-none focus:ring-2 focus:ring-violet-light transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-transparent"
                                                >
