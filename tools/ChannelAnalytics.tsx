...
import { Star, BarChart2, Youtube, TikTok, Lightbulb, TrendingUp, TrendingDown, ExternalLink, ChevronDown } from '../components/Icons';
...
export const ChannelAnalytics: React.FC<ChannelAnalyticsProps> = ({ onNavigate, activeChannelId, setActiveChannelId, initialInput }) => {
    const { user } = useAuth();
