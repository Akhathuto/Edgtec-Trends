...
import { ToolId, KeywordAnalysis } from '../types';
import Spinner from '../components/Spinner';
import { Search, Lightbulb, TrendingUp } from '../components/Icons';
...
export const KeywordResearch: React.FC<KeywordResearchProps> = ({ onNavigate, initialInput }) => {
