...
import { FullReport, ToolId } from '../types';
import Spinner from '../components/Spinner';
import { FileText, Star, Download, Sparkles, Lightbulb, DollarSign } from '../components/Icons';
...
export const StrategyReport: React.FC<StrategyReportProps> = ({ onNavigate, initialInput }) => {
    ...
    if (user?.plan !== 'pro') {
        return (
            <div className="bg-brand-glass border border-slate-700/50 rounded-xl p-8 shadow-xl backdrop-blur-xl text-center flex flex-col items-center animate-slide-in-up">
                ...
                <button onClick={() => onNavigate('pricing')} className="button-primary" title="View subscription plans to upgrade">
                    View Plans
                </button>
            </div>
        )
