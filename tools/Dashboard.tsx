        ...
        <div className="animate-slide-in-up space-y-8">
                ...
                <div className="lg:col-span-1 space-y-8">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <QuickCreateButton icon={<Lightbulb className="w-8 h-8 text-yellow-300" />} label="Content Idea" toolId="script-writer" onClick={onNavigate} />
                            <QuickCreateButton icon={<Video className="w-8 h-8 text-red-300" />} label="Video" toolId="media-generator" onClick={onNavigate} />
                            <QuickCreateButton icon={<DollarSign className="w-8 h-8 text-green-300" />} label="Monetization" toolId="monetization-guide" onClick={onNavigate} />
                            <QuickCreateButton icon={<FileText className="w-8 h-8 text-blue-300" />} label="Full Report" toolId="strategy-report" onClick={onNavigate} />
                            <QuickCreateButton icon={<Rocket className="w-8 h-8 text-rose-400" />} label="Growth Plan" toolId="growth-planner" onClick={onNavigate} />
                            <QuickCreateButton icon={<Briefcase className="w-8 h-8 text-cyan-300" />} label="Brand Connect" toolId="brand-connect" onClick={onNavigate} />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                     <button onClick={() => onNavigate('trends-keywords')} className="interactive-card text-left">
                      ...
                      <button onClick={() => onNavigate('content-analyzer')} className="interactive-card text-left">
                      ...
                      <button onClick={() => onNavigate('nolo-ai')} className="interactive-card text-left">
                     ...
                     <button onClick={() => onNavigate('seo-automation')} className="interactive-card text-left">
                        <SearchCode className="w-6 h-6 text-violet-400 mb-2"/>
                        <h3 className="font-bold text-lg text-white">SEO Automation</h3>
                        <p className="text-sm text-slate-400">Automate your SEO metadata generation.</p>
                     </button>
                     <button onClick={() => onNavigate('thumbnail-ideas')} className="interactive-card text-left">
                        <Image className="w-6 h-6 text-violet-400 mb-2"/>
                        <h3 className="font-bold text-lg text-white">Thumbnail Ideas</h3>
                        <p className="text-sm text-slate-400">Generate viral thumbnail concepts and images.</p>
                     </button>
                </div>
            </div>
