...
import { Star, Link, Rocket, CheckCircle, FileText, BarChart2, Users, Eye, ChevronDown } from '../components/Icons';
...
export const GrowthPlanner: React.FC<GrowthPlannerProps> = ({ onNavigate, activeChannelId }) => {
