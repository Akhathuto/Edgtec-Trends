...
import { Youtube, Film, DollarSign, Users, Target, CheckCircle, TikTok } from '../components/Icons';
...
export const MonetizationGuide: React.FC<MonetizationGuideProps> = ({ onNavigate }) => {
