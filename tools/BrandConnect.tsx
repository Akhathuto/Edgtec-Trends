...
import { ToolId, SponsorshipOpportunity, BrandPitch } from '../types';
import Spinner from '../components/Spinner';
import { Star, Link, Briefcase, ChevronDown, Copy, FileText, Send } from '../components/Icons';
...
export const BrandConnect: React.FC<BrandConnectProps> = ({ onNavigate, activeChannelId }) => {
