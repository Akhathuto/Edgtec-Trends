...
import {
  ...
  RefreshCw, Briefcase, Star, Scissors, PenTool, Clapperboard, FileText
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              ...
              <ul className="list-disc list-inside ml-4">
                <li><strong>Your Channels:</strong> Displays a live snapshot of your connected channels' metrics. Click a channel to go to its full <button onClick={() => onNavigate('analytics')} className="text-violet-400 underline hover:text-violet-300">Analytics</button> page.</li>
      ...
      topics: [
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>The <button onClick={() => onNavigate('trends-keywords')} className="text-violet-400 underline hover:text-violet-300">Trends</button> page is your key to staying relevant. You can:</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Use the <button onClick={() => onNavigate('trends-keywords')} className="text-violet-400 underline hover:text-violet-300">Keyword Research</button> tool to find untapped content opportunities.</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Nolo, your AI Co-pilot, is available in the <button onClick={() => onNavigate('nolo-ai')} className="text-violet-400 underline hover:text-violet-300">AI Chat</button> tab for Pro users.</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Assemble your creative team with <button onClick={() => onNavigate('nolo-ai')} className="text-violet-400 underline hover:text-violet-300">AI Agents</button>. Each agent is a specialist:</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>All content you generate is automatically saved in <button onClick={() => onNavigate('content-history')} className="text-violet-400 underline hover:text-violet-300">My Content</button>.</p>
              <ul className="list-disc list-inside ml-4">
      ...
      topics: [
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Never run out of ideas with our <button onClick={() => onNavigate('script-writer')} className="text-violet-400 underline hover:text-violet-300">Content Generator</button>.</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Craft the perfect input for our AI tools using the <button onClick={() => onNavigate('prompt')} className="text-violet-400 underline hover:text-violet-300">Prompt Generator</button>.</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              ...
              <ul className="list-disc list-inside ml-4">
                <li><button onClick={() => onNavigate('media-generator')} className="text-violet-400 underline hover:text-violet-300">Video Generator</button>: Create videos for any platform from a prompt or by animating an image.</li>
                <li><button onClick={() => onNavigate('media-generator')} className="text-violet-400 underline hover:text-violet-300">Animation Creator</button>: Generate animated clips in various styles.</li>
                <li><button onClick={() => onNavigate('media-generator')} className="text-violet-400 underline hover:text-violet-300">GIF Creator</button>: Create short, looping GIFs for social media.</li>
              </ul>
            </div>
          )
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              ...
              <ul className="list-disc list-inside ml-4">
                <li><button onClick={() => onNavigate('media-editor')} className="text-violet-400 underline hover:text-violet-300">Image Editor</button>: Edit any image just by typing what you want to change.</li>
                <li><button onClick={() => onNavigate('media-generator')} className="text-violet-400 underline hover:text-violet-300">Logo Creator</button>: Generate a professional logo for your brand or channel.</li>
              </ul>
            </div>
          )
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>The <button onClick={() => onNavigate('video-editor')} className="text-violet-400 underline hover:text-violet-300">Video Editor</button> (Pro feature) lets you modify your existing videos with AI.</p>
              <ul className="list-disc list-inside ml-4">
      ...
      topics: [
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>The <button onClick={() => onNavigate('monetization-guide')} className="text-violet-400 underline hover:text-violet-300">Monetization Guide</button> provides personalized strategies.</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Get AI-powered insights with <button onClick={() => onNavigate('analytics')} className="text-violet-400 underline hover:text-violet-300">Channel Analytics</button> (Pro feature).</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Generate a personalized, multi-point growth plan with the <button onClick={() => onNavigate('growth-planner')} className="text-violet-400 underline hover:text-violet-300">Channel Growth</button> tool (Pro feature).</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>The <button onClick={() => onNavigate('content-analyzer')} className="text-violet-400 underline hover:text-violet-300">Strategy Report</button> (Pro feature) combines multiple tools into one comprehensive document.</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Use the <button onClick={() => onNavigate('content-analyzer')} className="text-violet-400 underline hover:text-violet-300">Video Analyzer</button> to get an AI breakdown of any YouTube or TikTok video.</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Turn one video into multiple pieces of content with the <button onClick={() => onNavigate('content-repurposing')} className="text-violet-400 underline hover:text-violet-300">Repurpose Content</button> tool.</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Find sponsors and generate pitch emails with <button onClick={() => onNavigate('collaboration')} className="text-violet-400 underline hover:text-violet-300">Brand Connect</button> (Pro feature).</p>
              <ul className="list-disc list-inside ml-4">
      ...
      topics: [
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>Keep your account up-to-date in the <button onClick={() => onNavigate('profile')} className="text-violet-400 underline hover:text-violet-300">Profile</button> section.</p>
              <ul className="list-disc list-inside ml-4">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-2 text-slate-300">
              <p>You can view all available plans on the <button onClick={() => onNavigate('pricing')} className="text-violet-400 underline hover:text-violet-300">Pricing</button> page.</p>
              <ul className="list-disc list-inside ml-4">
